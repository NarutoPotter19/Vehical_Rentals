              ...
              <div class="grid md:grid-cols-2">
                <div class="h-full pr-6">
                  <p class="mt-3 mb-12 text-lg text-gray-600 dark:text-slate-400">
                    Huron Automobile Renteal System is automobile rental site
                    where cars can be rented.
                  </p>
                    ...
                    <li class="flex">
                      ...
                      <div class="ml-4 mb-4">
                        ...
                        <p class="text-gray-600 dark:text-slate-400">
                          PricoTowers, Anakera Gate Junction
                        </p>
                        <p class="text-gray-600 dark:text-slate-400">
                          Bannerugatta Road, Bengaluru
                        </p>
                      </div>
                    </li>
                    <li class="flex">
                ...
                <div class="mb-2">
                  <div class="mx-0 mb-1 sm:mb-4">
                    ...
                    <div class="mx-0 mb-1 sm:mb-4">
                      <label
                        for="name"
                        class="pb-1 text-lg  uppercase tracking-wider"
                      >
                        Name
                      </label>
                      <input
                      ...
                      <div class="mx-0 mb-1 sm:mb-4">
                        <label
                          for="textarea"
                          class="pb-2 text-lg uppercase tracking-wider"
                        >
                          Message
                        </label>
                        <textarea
